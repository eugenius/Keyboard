...
$.keyboard = function(el, options){
	...
	base.isVisible = function() {
		return base.$keyboard.length ? base.$keyboard.is(":visible") : false;
	};
	...
	base.startup = function(){
		if ( !base.$keyboard.length ) {
			...
			o.language = o.layout && $.keyboard.language[ o.layout.split('-')[0] ] ?
			...
			base.regex = $.keyboard.language[o.language].comboRegex || $.keyboard.comboRegex;
		...
		if (o.reposition && $.ui && $.ui.position) {
	...
	$.keyboard.defaultOptions = {
		...
		// keyboard layout language (if not found in layout name)
		language     : 'english',
		rtl          : false,
